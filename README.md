This is my version of the "**Use an API to Create an Employee Directory**" project for **Teamtreehouse's Frontend Web Development & Fullstack JavaScript Techdegree**.
